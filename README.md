...
#### (ii) Creating the Embedded Dashboard
...
* We will create 2 tabs (Gross Profit and Revenue Analysis And Unit Sold Analysis)

- Under Gross Profit and Revenue Analysis tab, we would create 6 widgets.
##### (a) Gross Profit analysis by year
##### (b) Gross Profit analysis by Store Location
##### (c) Revenue Generated by Order Method
##### (d) Revenue Generated by Store Location
##### (e) Gross Profit Analysis by Order Method
##### (f) Types of Watches sold Analysis by Order Method
