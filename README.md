...
* We will create 2 tabs (Gross Profit and Revenue Analysis And Unit Sold Analysis). Under Gross Profit and Revenue Analysis tab, we would create 6 widgets.
 - Gross Profit analysis by year.
 - Gross Profit analysis by Store Location.
